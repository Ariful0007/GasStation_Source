...
public class Add_NewMosque extends AppCompatActivity {

    FirebaseFirestore firebaseFirestore;
    EditText membername,fathernmae,mothername,address,mobile,id_member,
            magrib,Isha,Jumma,note;
    Button cirLoginButton;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add__new_mosque);
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(mosque_name)||TextUtils.isEmpty(location)||
                    ...
                    if (TextUtils.isEmpty(mootes)) {
                        AlertDialog.Builder builder=new AlertDialog.Builder(Add_NewMosque.this);
                        builder.setTitle("Confirmation")
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                dialog.dismiss();
                                final KProgressHUD progressDialog=  KProgressHUD.create(Add_NewMosque.this)
                                ...
                                mosjidmodel mosjidmodel=new mosjidmodel(mosque_name,location,fazar,juhur,asor,magribb,isha,jumma,"not set",sunrise,"time",ts);
                        ...
                        builder.setTitle("Confirmation")
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Long tsLong = System.currentTimeMillis()/1000;
                                String ts = tsLong.toString();
                                mosjidmodel mosjidmodel=new mosjidmodel(mosque_name,location,fazar,juhur,asor,magribb,isha,jumma,mootes,sunrise,"time",ts);
                                firebaseFirestore.collection("Pending")
                                        .document(ts)
                                        .set(mosjidmodel)
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
